...
public class RenderItemNew extends Render
{
	 ...
	 */
	public void renderItemIntoGUI(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_, float p_77015_4_, float p_77015_5_)
	{
		this.renderItemIntoGUI(p_77015_1_, p_77015_2_, p_77015_3_, p_77015_4_, p_77015_5_, false);
	}

	public void renderItemIntoGUI(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_, float posX, float posY, boolean renderEffect)
	{
		...
		if (p_77015_3_.getItemSpriteNumber() == 0 && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(p_77015_3_.getItem()).getRenderType()))
		{
			...
			GL11.glPushMatrix();
			GL11.glTranslatef(posX - 2, posY + 3, -3.0F + this.zLevel);
		...
		else if (p_77015_3_.getItem().requiresMultipleRenderPasses())
		{
			...
			tessellator.addVertex(posX - 2, posY + 18, (double)this.zLevel);
			tessellator.addVertex(posX + 18, posY + 18, (double)this.zLevel);
			tessellator.addVertex(posX + 18, posY - 2, (double)this.zLevel);
			tessellator.addVertex(posX - 2, posY - 2, (double)this.zLevel);
			tessellator.draw();
			...
			for (l = 0; l < item.getRenderPasses(k); ++l)
			{
				...
				this.renderIcon(posX, posY, iicon, 16, 16);
				...
				{
					renderEffect(p_77015_2_, posX, posY);
				}
			}
		...
		else
		{
			...
			this.renderIcon(posX, posY, (IIcon)object, 16, 16);
	...
	public void renderItemAndEffectIntoGUI(FontRenderer p_82406_1_, TextureManager p_82406_2_, final ItemStack p_82406_3_, float p_82406_4_, float p_82406_5_, boolean effect)
	{
		if (p_82406_3_ != null)
		{
			this.zLevel = 0;
			...
			try
			{
				if (!ForgeHooksClient.renderInventoryItem(this.field_147909_c, p_82406_2_, p_82406_3_, renderWithColor, zLevel, p_82406_4_, p_82406_5_))
				{
					this.renderItemIntoGUI(p_82406_1_, p_82406_2_, p_82406_3_, p_82406_4_, p_82406_5_, effect);
				}
			}
			...
			if (effect && p_82406_3_.hasEffect())
			{
				GL11.glDepthFunc(GL11.GL_EQUAL);
				GL11.glDisable(GL11.GL_LIGHTING);
	...
	public void renderEffect(TextureManager manager, float x, float y)
	{
		GL11.glDepthFunc(GL11.GL_EQUAL);
		GL11.glDisable(GL11.GL_LIGHTING);
		GL11.glDepthMask(false);
	...
	private void renderGlint(float p_77018_1_, float p_77018_2_, float p_77018_3_, float p_77018_4_, float p_77018_5_)
	{
	...
	public void renderIcon(float posX, float posY, IIcon p_94149_3_, int p_94149_4_, int p_94149_5_)
	{
		Tessellator tessellator = Tessellator.instance;
		tessellator.startDrawingQuads();
		tessellator.addVertexWithUV((double)(posX + 0), (double)(posY + p_94149_5_), (double)this.zLevel, (double)p_94149_3_.getMinU(), (double)p_94149_3_.getMaxV());
		tessellator.addVertexWithUV((double)(posX + p_94149_4_), (double)(posY + p_94149_5_), (double)this.zLevel, (double)p_94149_3_.getMaxU(), (double)p_94149_3_.getMaxV());
		tessellator.addVertexWithUV((double)(posX + p_94149_4_), (double)(posY + 0), (double)this.zLevel, (double)p_94149_3_.getMaxU(), (double)p_94149_3_.getMinV());
		tessellator.addVertexWithUV((double)(posX + 0), (double)(posY + 0), (double)this.zLevel, (double)p_94149_3_.getMinU(), (double)p_94149_3_.getMinV());
		tessellator.draw();
	}
	...
	private static RenderItemNew instance;
	/**
	 ...
	 */
	public static RenderItemNew getInstance()
	{
		if (instance == null) instance = new RenderItemNew();
		return instance;
	}
	/*==================================== FORGE END =============================================*/
}