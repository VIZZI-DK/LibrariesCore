...
public class RenderGlobal implements IWorldAccess {
    ...
    public void loadRenderers() {
        if (this.theWorld != null) {
            KrogenitShaders.worldRenderers.clear();
    ...
    public int sortAndRender(EntityLivingBase p_72719_1_, int p_72719_2_, double p_72719_3_) {
        ...
        if (this.prevChunkSortX != p_72719_1_.chunkCoordX || this.prevChunkSortY != p_72719_1_.chunkCoordY || this.prevChunkSortZ != p_72719_1_.chunkCoordZ || d3 * d3 + d4 * d4 + d5 * d5 > 16.0) {
                    ...
                    if (this.sortedWorldRenderers[j1].skipAllRenderPasses()) {
                        ...
                        if (this.sortedWorldRenderers[j1].isInFrustum && !this.sortedWorldRenderers[j1].isWaitingOnOcclusionQuery) {
                            ...
                            if (this.cloudTickCounter % k1 == j1 % k1) {
                                ...
                                ARBOcclusionQuery.glBeginQueryARB(35092, this.sortedWorldRenderers[j1].glOcclusionQuery);
        ...
        if ((skyProvider = this.mc.theWorld.provider.getSkyRenderer()) != null) {
            ...
            if (this.mc.theWorld.provider.dimensionId == 1) {
                ...
                if (afloat != null) {
                    ...
                    for(j = 0; j <= b0; ++j) {
                        f11 = (float)j * 3.1415927F * 2.0F / (float)b0;
                        f12 = MathHelper.sin(f11);
                        f13 = MathHelper.cos(f11);
                ...
                f12 = (float)(b0 + 0) / 4.0F;
                f13 = (float)(j + 0) / 2.0F;
                float f16 = (float)(b0 + 1) / 4.0F;
                float f17 = (float)(j + 1) / 2.0F;
                tessellator1.startDrawingQuads();
                tessellator1.addVertexWithUV((double)(-f10), -100.0, (double)f10, (double)f16, (double)f17);
                tessellator1.addVertexWithUV((double)f10, -100.0, (double)f10, (double)f12, (double)f17);
                tessellator1.addVertexWithUV((double)f10, -100.0, (double)(-f10), (double)f12, (double)f13);
                tessellator1.addVertexWithUV((double)(-f10), -100.0, (double)(-f10), (double)f16, (double)f13);
                tessellator1.draw();
                GL11.glDisable(3553);
        ...
        if ((renderer = this.theWorld.provider.getCloudRenderer()) != null) {
            ...
            if (this.mc.theWorld.provider.isSurfaceWorld()) {
                if (this.mc.gameSettings.fancyGraphics) {
                    ...
                    double d0 = this.mc.renderViewEntity.prevPosX + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.prevPosX) * (double)p_72718_1_ + d2 * 0.029999999329447746;
                    ...
                    int j = MathHelper.floor_double(d0 / 2048.0);
    ...
    public void renderCloudsFancy(float p_72736_1_) {
        ...
        double d1 = (this.mc.renderViewEntity.prevPosX + (this.mc.renderViewEntity.posX - this.mc.renderViewEntity.prevPosX) * (double)p_72736_1_ + d0 * 0.029999999329447746) / (double)f2;
        double d2 = (this.mc.renderViewEntity.prevPosZ + (this.mc.renderViewEntity.posZ - this.mc.renderViewEntity.prevPosZ) * (double)p_72736_1_) / (double)f2 + 0.33000001311302185;
            ...
            if (entityfx != null) {
                ...
                if (d6 * d6 + d7 * d7 + d8 * d8 > d9 * d9) {
                    ...
                    if (p_72726_1_.equals("bubble")) {
                        ...
                        entityfx = new EntitySpellParticleFX(this.theWorld, p_72726_2_, p_72726_4_, p_72726_6_, 0.0, 0.0, 0.0);
                        ...
                        entityfx = new EntityHeartFX(this.theWorld, p_72726_2_, p_72726_4_ + 0.5, p_72726_6_, p_72726_8_, p_72726_10_, p_72726_12_);
    ...
    public void playAuxSFX(EntityPlayer p_72706_1_, int p_72706_2_, int p_72706_3_, int p_72706_4_, int p_72706_5_, int p_72706_6_) {
        ...
        switch (p_72706_2_) {
            ...
            case 1003:
                if (Math.random() < 0.5) {
                    this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "random.door_open", 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                } else {
                    this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "random.door_close", 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                }
                break;
            case 1004:
            ...
            case 1005:
                ...
                break;
            case 1007:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.ghast.charge", 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1008:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.ghast.fireball", 10.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1009:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.ghast.fireball", 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1010:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.zombie.wood", 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1011:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.zombie.metal", 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1012:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.zombie.woodbreak", 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1014:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.wither.shoot", 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1015:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.bat.takeoff", 0.05F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1016:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.zombie.infect", 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1017:
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "mob.zombie.unfect", 2.0F, (random.nextFloat() - random.nextFloat()) * 0.2F + 1.0F, false);
                break;
            case 1020:
            ...
            case 2000:
                ...
                d1 = (double)p_72706_3_ + (double)j2 * 0.6 + 0.5;
                d2 = (double)p_72706_4_ + 0.5;
                double d9 = (double)p_72706_5_ + (double)j1 * 0.6 + 0.5;

                for(int k2 = 0; k2 < 10; ++k2) {
                    double d11 = random.nextDouble() * 0.2 + 0.01;
                    double d12 = d1 + (double)j2 * 0.01 + (random.nextDouble() - 0.5) * (double)j1 * 0.5;
                    d4 = d2 + (random.nextDouble() - 0.5) * 0.5;
                    d13 = d9 + (double)j1 * 0.01 + (random.nextDouble() - 0.5) * (double)j2 * 0.5;
                    d5 = (double)j2 * d11 + random.nextGaussian() * 0.01;
                    d6 = -0.03 + random.nextGaussian() * 0.01;
                    d7 = (double)j1 * d11 + random.nextGaussian() * 0.01;
            ...
            case 2002:
                ...
                for(k1 = 0; k1 < 8; ++k1) {
                    this.spawnParticle(s, d0, d1, d2, random.nextGaussian() * 0.15, random.nextDouble() * 0.2, random.nextGaussian() * 0.15);
                }
                ...
                for(l2 = 0; l2 < 100; ++l2) {
                    d4 = random.nextDouble() * 4.0;
                    d13 = random.nextDouble() * Math.PI * 2.0;
                    d5 = Math.cos(d13) * d4;
                    d6 = 0.01 + random.nextDouble() * 0.5;
                    d7 = Math.sin(d13) * d4;
                    EntityFX entityfx = this.doSpawnParticle(s1, d0 + d5 * 0.1, d1 + 0.3, d2 + d7 * 0.1, d5, d6, d7);
                    if (entityfx != null) {
                ...
                this.theWorld.playSound((double)p_72706_3_ + 0.5, (double)p_72706_4_ + 0.5, (double)p_72706_5_ + 0.5, "game.potion.smash", 1.0F, this.theWorld.rand.nextFloat() * 0.1F + 0.9F, false);
                break;
            case 2003:
                d0 = (double)p_72706_3_ + 0.5;
                d1 = (double)p_72706_4_;
                d2 = (double)p_72706_5_ + 0.5;
                ...
                for(d3 = 0.0; d3 < 6.283185307179586; d3 += 0.15707963267948966) {
                    this.spawnParticle("portal", d0 + Math.cos(d3) * 5.0, d1 - 0.4, d2 + Math.sin(d3) * 5.0, Math.cos(d3) * -5.0, 0.0, Math.sin(d3) * -5.0);
                    this.spawnParticle("portal", d0 + Math.cos(d3) * 5.0, d1 - 0.4, d2 + Math.sin(d3) * 5.0, Math.cos(d3) * -7.0, 0.0, Math.sin(d3) * -7.0);
                }

                return;
            case 2004:
                for(l2 = 0; l2 < 20; ++l2) {
                    d4 = (double)p_72706_3_ + 0.5 + ((double)this.theWorld.rand.nextFloat() - 0.5) * 2.0;
                    d13 = (double)p_72706_4_ + 0.5 + ((double)this.theWorld.rand.nextFloat() - 0.5) * 2.0;
                    d5 = (double)p_72706_5_ + 0.5 + ((double)this.theWorld.rand.nextFloat() - 0.5) * 2.0;
                    this.theWorld.spawnParticle("smoke", d4, d13, d5, 0.0, 0.0, 0.0);
                    this.theWorld.spawnParticle("flame", d4, d13, d5, 0.0, 0.0, 0.0);
                }
            ...
            case 2006:
                ...
                if (block.getMaterial() != Material.air) {
                    ...
                    for(int i2 = 0; i2 < l1; ++i2) {
                        ...
                        d6 = 0.20000000298023224 + d3 / 100.0;
                        d7 = (double)(MathHelper.cos(f3) * 0.2F) * d5 * d5 * (d3 + 0.2);
                        double d8 = (double)(MathHelper.sin(f3) * 0.2F) * d5 * d5 * (d3 + 0.2);
